 ...
 * nothing better to offer. {@code call}, inherited from {@link FieldValueFunction}, is handed the value and
 * the isSet / isNull flags instead, and is what a {@code GeneratedFunctionCaller} drives — one call site per
 ...
 */
public interface FieldWriter extends FieldValueFunction<Object, CodedOutputStream, Void> {
