 ...
 * array. {@code call}, inherited from {@link MutableFunctionWrite}, is what a {@code GeneratedCallerWrite}
 * drives — one call site per field number rather than one for the whole loop — and reads the tag back from the
 * stream, which is the {@code CallAtWrite} that just read it.
 * <p>
 ...
 */
public interface FieldReader extends MutableFunctionWrite<CodedInputStream, Void, Void> {
